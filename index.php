...
<section class="service_section bg-grey bd-bottom padding">
    <div class="container">
        ...
        <div id="trending_cuts_carousel" class="row ">
            <div class="col-sm-12 col-md-8 col-lg-4 sm-padding">
            ...
            <div class="col-sm-12 col-md-8 col-lg-4 sm-padding wow fadeInUp" data-wow-delay="300ms">
            ...
            <div class="col-sm-12 col-md-8 col-lg-4 sm-padding wow fadeInUp" data-wow-delay="400ms">
                <div class="service_content align-center">
            ...
            <div class="col-sm-12 col-md-8 col-lg-4 sm-padding wow fadeInUp" data-wow-delay="500ms">
                <div class="service_content align-center">
