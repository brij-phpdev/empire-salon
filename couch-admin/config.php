...
//    define( 'K_SITE_URL', 'http://www.test.com/subfolder1/subfolder2/mysite/' );
    ...
    define( 'K_ADMIN_PAGE', 'my_admin.php' );
    ...
    define( 'K_EMAIL_TO', 'mb.consulting.031220@gmail.com' );

    // 14.
    // Will be used as the sender of messages delivered by contact forms to the address above.
    define( 'K_EMAIL_FROM', 'empiresalonagra@gmail.com' );
    ...
    define( 'K_RECAPTCHA_SITE_KEY', '6LdzJdAoAAAAAK4WMtskrtsExhaMM4zCwslMre6H' );
    define( 'K_RECAPTCHA_SECRET_KEY', '6LdzJdAoAAAAAM4PAdjrbF0zfb7SkUQs13BS1Cxh' );
