...
//                                echo $price_to_pay;
                            ?>
                                                                            ...
                                                                            <label style="" for="radio-1a-<?php echo $package_service['id'] ?>" data-mid="<?php echo $price_to_pay ?>" data-package="<?php echo html_entity_decode($package_service['title']) ?>" class="default_btn book-service">Book Service</label>
                                                                        </div>
                                                                    </li>
